...
const draggableComponent = defineComponent({
  ...
  methods: {
    ...
    onDragUpdate(evt) {
      ...
      items.forEach((v, i) => {
        const oldIndex = oldIndicies[i].index;
        const newIndex = newIndicies[i].index;
        if(newIndex > oldIndex) {
          this.updatePosition(oldIndex - i, newIndex + l - i);
        } else {
          this.updatePosition(oldIndex, newIndex);
        }
      });
